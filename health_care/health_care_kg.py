...
def create_specialization_node(driver, specialization):
    print("Create Specialization Node")
    create_specialization_query = """
    MERGE (p:Specialization {name: $specialization})
    """
...
def create_location_node(driver,location):
    print("Creating locaiton node")

    create_location_query="""MERGE(l:Location{name:$location})"""
...
def main():
    ...
    with open(r"./health_care/healthcare.csv", mode="r") as file:
